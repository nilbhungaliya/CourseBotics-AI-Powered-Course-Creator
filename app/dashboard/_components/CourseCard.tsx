    ...
    return (
        ...
        >
            ...
            {course.isPublished ? (
                ...
                <div className="absolute top-3 left-3 z-20">
                    <Badge variant="outline" className="bg-background/80 backdrop-blur-sm border-amber-500/30 text-amber-500">
                        Draft
                    </Badge>
                </div>
            )}
            ...
            <Link href={`/course/${courseId}`} className="block overflow-hidden">
                <div className="relative aspect-video overflow-hidden">
                    ...
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                        <Button variant="secondary" className="bg-background/80 backdrop-blur-sm shadow-md">
                            View Course
                        </Button>
                    </div>
                </div>
