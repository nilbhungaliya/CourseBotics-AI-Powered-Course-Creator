...
function startCourse() {
  ...
  return (
    <div>
      ...
      <div className="fixed md:w-64 hidden md:block h-screen border-r shadow-sm">
        ...
        <div className=" overflow-y-scroll h-screen pb-10">
          {course?.courseOutput.chapters.map((chapter, index) => (
            <div
              key={index}
              className={`cursor-pointer hover:bg-purple-100 transition-all duration-200 ${
      ...
      <div className="md:ml-64 h-full overflow-y-scroll">
        {selectedChapter ? (
          <div>
            <ChapterContent
          ...
          <div className="p-10 flex justify-center flex-col items-center">
            ...
            <p className="mt-10">
              <UserToolTip
                ...
                userProfileImage={
                  course?.userprofileimage || "/userProfile.png"
                }
              />
            </p>
          </div>
